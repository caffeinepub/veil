      ...
      >
        <DialogHeader className="space-y-3">
          ...
          <DialogDescription className="text-center text-sm leading-relaxed">
            VEIL is a safe space for honest expression. Everything you write
            here is private by default. Please be kind to yourself and others.
            This is not a crisis service — if you are in immediate danger,
