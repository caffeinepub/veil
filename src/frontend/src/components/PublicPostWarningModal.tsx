      ...
      >
        <DialogHeader className="space-y-3">
          ...
          <DialogDescription className="text-center text-sm leading-relaxed">
            You are about to share this entry with the entire VEIL community.
            While pseudonyms protect your identity, the content will be visible
            to all members. Please ensure you are comfortable with this before
            proceeding.
          </DialogDescription>
        </DialogHeader>
        <div className="pt-2">
