...
const EMOTION_CONFIG: Record<string, { label: string; className: string }> = {
  [EmotionType.happy]: {
    label: "✦ Happy",
    className:
      "bg-emotion-happy/15 text-emotion-happy border border-emotion-happy/30",
  },
  [EmotionType.confess]: {
    label: "◈ Confess",
    className:
      "bg-emotion-confess/15 text-emotion-confess border border-emotion-confess/30",
  },
  [EmotionType.broke]: {
    label: "◌ Broke",
    className:
      "bg-emotion-broke/15 text-emotion-broke border border-emotion-broke/30",
  },
};
